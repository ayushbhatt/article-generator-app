...
const _c0 = function (a0) { return { "hover-shadow": a0 }; };
class AppComponent {
    constructor(http) {
        this.http = http;
    ...
    randomAdvice() {
        this.http.get('https://api.adviceslip.com/advice').subscribe(data => {
            // var totalAngularPackages = data.total;
            this.advice = data.slip.advice;
            this.id = data.slip.id;
            console.log(data.slip.advice);
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 14, vars: 5, consts: [[1, "main-bg"], [1, "box"], [1, "id"], [1, "advice"], [1, "divider"], ["data", "../assets/pattern-divider-desktop.svg"], [1, "button-position"], [1, "button"], [1, "custom-button", 3, "ngClass", "mouseenter", "mouseleave", "click"], ["data", "../assets/icon-dice.svg"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mouseenter", function AppComponent_Template_button_mouseenter_12_listener() { return ctx.mouseEnterEvent(); })("mouseleave", function AppComponent_Template_button_mouseleave_12_listener() { return ctx.mouseLeaveEvent(); })("click", function AppComponent_Template_button_click_12_listener() { return ctx.randomAdvice(); });
...
module.exports = __webpack_require__(/*! C:\Users\ayush\OneDrive\Desktop\Angular Projects\article-generator-app\src\main.ts */"./src/main.ts");
